...
Bidirectional streaming uses a different event model than [standard streaming](/docs/user-guide/concepts/streaming/index.md):
...
See [Connection Lifecycle](/docs/user-guide/concepts/bidirectional-streaming/agent/index.md#connection-restart) for more details on timeout handling.
...
Emitted when the model requests tool execution. See [Tools Overview](/docs/user-guide/concepts/tools/index.md) for details.
