...
For a comprehensive introduction to the hooks concept and general patterns, see the [Hooks documentation](/docs/user-guide/concepts/agents/hooks/index.md). This guide focuses on bidirectional streaming-specific events and use cases.
...
For additional best practices on performance considerations, error handling, composability, and advanced patterns, see the [Hooks documentation](/docs/user-guide/concepts/agents/hooks/index.md).
