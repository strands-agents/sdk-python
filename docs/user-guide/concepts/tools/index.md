...
(( tab "Python" ))
Define any Python function as a tool by using the [`@tool`](/docs/api/python/strands.tools.decorator#tool) decorator. Function decorated tools can be placed anywhere in your codebase and imported in to your agent’s list of tools.
...
For more details on building custom tools, see [Creating Custom Tools](/docs/user-guide/concepts/tools/custom-tools/index.md).
(( /tab "TypeScript" ))
...
For more details on building custom Python tools, see [Creating Custom Tools](/docs/user-guide/concepts/tools/custom-tools/index.md).
(( /tab "Python" ))
...
For a complete list of available tools, see [Community Tools Package](/docs/user-guide/concepts/tools/community-tools-package/index.md).
(( /tab "Python" ))
...
Agents can be passed directly in another agent’s `tools` array — the SDK automatically converts them into tools. Use `.as_tool()``.asTool()` when you need to customize the tool name, description, or context behavior. For full details, see [Agents as Tools](/docs/user-guide/concepts/multi-agent/agents-as-tools/index.md).
...
- [Build with AI](/docs/user-guide/build-with-ai/index.md) (2 shared tags)
