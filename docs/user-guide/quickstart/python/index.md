...
This observability data helps you debug agent behavior, optimize performance, and understand the agent’s reasoning process. For detailed information, see [Observability](/docs/user-guide/observability-evaluation/observability/index.md), [Traces](/docs/user-guide/observability-evaluation/traces/index.md), and [Metrics](/docs/user-guide/observability-evaluation/metrics/index.md).
...
Learn more in the [Callback Handlers](/docs/user-guide/concepts/streaming/callback-handlers/index.md) documentation.
...
See the [Logs documentation](/docs/user-guide/observability-evaluation/logs/index.md) for more information.

## Model Providers

### Identifying a configured model

Strands defaults to the Bedrock model provider using Claude Sonnet 4. The model your agent is using can be retrieved by accessing [`model.config`](/docs/api/python/strands.models.model#Model.get_config):
...
-   **[Anthropic](/docs/user-guide/concepts/model-providers/anthropic/index.md)** - Direct API access to Claude models
-   **[LiteLLM](/docs/user-guide/concepts/model-providers/litellm/index.md)** - Unified interface for OpenAI, Mistral, and other providers
-   **[Llama API](/docs/user-guide/concepts/model-providers/llamaapi/index.md)** - Access to Meta’s Llama models
-   **[Mistral](/docs/user-guide/concepts/model-providers/mistral/index.md)** - Access to Mistral models
...
We can create a custom callback function (named a [callback handler](/docs/user-guide/concepts/streaming/callback-handlers/index.md)) that is invoked at various points throughout an agent’s lifecycle.
...
See the [Callback Handlers](/docs/user-guide/concepts/streaming/callback-handlers/index.md) documentation for full details.
