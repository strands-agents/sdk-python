...
For the TypeScript equivalent and the full configuration reference, see [Bedrock guardrails](/docs/user-guide/concepts/model-providers/amazon-bedrock/index.md#guardrails).
...
-   System prompt engineering with safety instructions (see the [Prompt Engineering](/docs/user-guide/safety-security/prompt-engineering/index.md) section of our documentation)
