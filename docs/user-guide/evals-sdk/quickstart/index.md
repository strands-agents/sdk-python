...
`--agent MODULE:ATTR` points at the same factory you’d pass to `experiment.run_evaluations` in Python. See the [CLI reference](/docs/user-guide/evals-sdk/cli/index.md) for `report`, `diagnose`, `generate`, CI exit codes, and the full flag set.
...
-   [Command-Line Interface](/docs/user-guide/evals-sdk/cli/index.md) - Run experiments and diagnose sessions from the shell or CI
-   [Task Decorator](/docs/user-guide/evals-sdk/how-to/eval_task/index.md) - Simplify task functions with `@eval_task`
-   [Output Evaluator](/docs/user-guide/evals-sdk/evaluators/output_evaluator/index.md) - LLM-based output evaluation with custom rubrics
-   [Trajectory Evaluator](/docs/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md) - Tool usage and sequence evaluation
-   [Helpfulness Evaluator](/docs/user-guide/evals-sdk/evaluators/helpfulness_evaluator/index.md) - Seven-level helpfulness assessment
-   [Correctness Evaluator](/docs/user-guide/evals-sdk/evaluators/correctness_evaluator/index.md) - Factual correctness with optional reference comparison
-   [Deterministic Evaluators](/docs/user-guide/evals-sdk/evaluators/deterministic_evaluators/index.md) - Fast, code-based checks (Equals, Contains, ToolCalled)
-   [Custom Evaluators](/docs/user-guide/evals-sdk/evaluators/custom_evaluator/index.md) - Build domain-specific evaluation logic
-   [Tool Simulation](/docs/user-guide/evals-sdk/simulators/tool_simulation/index.md) - Test tool-using agents without real infrastructure
-   [Result Caching](/docs/user-guide/evals-sdk/how-to/result_caching/index.md) - Cache task results to iterate on evaluators without re-running agents
