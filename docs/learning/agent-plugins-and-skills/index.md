...
*Code for this lesson can be found [**here**](https://github.com/aws-samples/sample-building-with-strands-course/tree/main/samples/06-plugins-skills).*
...
*Learn more: [Plugins](/docs/user-guide/concepts/plugins/index.md) · [Skills](/docs/user-guide/concepts/plugins/skills/index.md)*