...
*Code for this lesson can be found [**here**](https://github.com/aws-samples/sample-building-with-strands-course/tree/main/samples/04-callbacks-streaming).*
...
*Learn more: [Callback Handlers](/docs/user-guide/concepts/streaming/callback-handlers/index.md) · [Async Iterators](/docs/user-guide/concepts/streaming/async-iterators/index.md)*