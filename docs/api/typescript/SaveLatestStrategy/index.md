...
Defined in: [src/session/session-manager.ts:47](https://github.com/strands-agents/harness-sdk/blob/1fd743a7fe7cba5547824c6123aab7e6f3a7f10f/strands-ts/src/session/session-manager.ts#L47)
