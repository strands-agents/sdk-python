-   **Classes**
    ...
    -   [ClassifierStrategy](/docs/api/typescript/ClassifierStrategy/index.md)
    ...
    -   [FallbackStrategy](/docs/api/typescript/FallbackStrategy/index.md)
    ...
    -   [ModelRouter](/docs/api/typescript/ModelRouter/index.md)
    ...
    -   [RoutingCandidate](/docs/api/typescript/RoutingCandidate/index.md)
...
-   **Interfaces**
    ...
    -   [BackgroundTasksConfig](/docs/api/typescript/BackgroundTasksConfig/index.md)
    ...
    -   [ClassifierStrategyOptions](/docs/api/typescript/ClassifierStrategyOptions/index.md)
    ...
    -   [ModelRouterOptions](/docs/api/typescript/ModelRouterOptions/index.md)
    ...
    -   [RoutingAttempt](/docs/api/typescript/RoutingAttempt/index.md)
    -   [RoutingCandidateOptions](/docs/api/typescript/RoutingCandidateOptions/index.md)
    -   [RoutingContext](/docs/api/typescript/RoutingContext/index.md)
...
-   **Type Aliases**
    ...
    -   [CandidateInput](/docs/api/typescript/CandidateInput/index.md)
