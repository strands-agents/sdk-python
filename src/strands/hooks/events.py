...
class BeforeNodeCallEvent(BaseHookEvent, _Interruptible):
    ...
    Attributes:
        ...
        node_input: The input that will be passed to the node. This is built from dependency outputs
            and the original task. Can be modified by hooks to customize the input before it reaches the node.
    """
