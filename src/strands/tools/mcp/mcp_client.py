            ...
            if use_task:
                ...
                async def _call_as_task() -> MCPCallToolResult:
                    return await self._call_tool_as_task_and_poll_async(
                        name, arguments, poll_timeout_seconds=poll_timeout
                    )

                call_tool_result: MCPCallToolResult = self._invoke_on_background_thread(_call_as_task()).result()
            else:
                ...
                call_tool_result = self._invoke_on_background_thread(_call_tool_direct()).result()
    ...
    async def call_tool_async(
        ...
        try:
            ...
            if use_task:
                ...
                future = self._invoke_on_background_thread(_call_as_task())
                ...
                future = self._invoke_on_background_thread(_call_tool_direct())
