...
def test_format_request_cache_tools_with_ttl_from_cache_config(model, messages, model_id, tool_spec, cache_type):
    """Test that cache_config.ttl propagates into the toolConfig cachePoint."""
    model.update_config(cache_tools=cache_type, cache_config=CacheConfig(strategy="auto", ttl="5m"))
...
def test_format_request_cache_tools_without_ttl(model, messages, model_id, tool_spec, cache_type):
    """Test that toolConfig cachePoint omits TTL when cache_config has no ttl."""
