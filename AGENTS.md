...
│   │   │   ├── cedar/            # Cedar authorization handler
│   │   │   │   ├── __tests__/
│   │   │   │   ├── cedar.ts
│   │   │   │   └── index.ts
...
- **`strands-ts/src/vended-interventions/`**: Optional vended intervention handlers (cedar, hitl, steering — not part of core SDK, independently importable)
