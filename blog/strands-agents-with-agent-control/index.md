...
Today we’re excited to add another option to that toolkit: a launch partnership with Agent Control, an open-source runtime guardrails framework built by [Galileo](https://www.galileo.ai/), which is now [available for Strands](/docs/community/plugins/agent-control/index.md).
