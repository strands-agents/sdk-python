...
tags: ["Physical AI", "Robotics", "Edge Computing", "Best Practices"]
---
...
![Edge-cloud continuum diagram](/_astro/image-9-3.9Ii_1eow_Z1VVWpU.webp)
...
![Cloud capabilities diagram](/_astro/image-10-4.Dh3R_FIn_OVDe0.webp)
...
A simple starting point is running models locally on edge devices. With Strands’ [Ollama provider](/docs/user-guide/concepts/model-providers/ollama/index.md), you can run open-source models like Qwen3-VL directly on edge hardware. Strands also supports [llama.cpp](/docs/user-guide/concepts/model-providers/llamacpp/index.md) for high-performance inference with quantized models, and [MLX](https://github.com/cagataycali/strands-mlx) for running models on Apple Silicon:
...
![VLA model architecture diagram](/_astro/image-11-3.3OgJcttA_ZPADpN.webp)
...
![Fleet learning diagram](/_astro/image-13-4.DMDkUwn5_EO46f.webp)
