...
> **Update:** Since this launch, Strands Labs has grown. **Robots Sim** has been archived - its simulation capability now ships built into [Strands Robots](https://strandsagents.com/latest/documentation/docs/labs/robots/) (a `Robot()` call returns a MuJoCo simulation by default). Strands Labs today also includes [Strands for Cosmos](https://strandsagents.com/latest/documentation/docs/labs/strands-for-cosmos/), [Benchmark Harnesses](https://strandsagents.com/latest/documentation/docs/labs/benchmark-harnesses/), [Harness Optimizer](https://strandsagents.com/latest/documentation/docs/labs/harness-optimizer/), and [PyWebRTC Audio](https://strandsagents.com/latest/documentation/docs/labs/pywebrtc-audio/). See the [Strands Labs overview](https://strandsagents.com/latest/documentation/docs/labs/) for the full, current list.
...
**Get started with Strands Robots:** [Documentation](https://strandsagents.com/latest/documentation/docs/labs/robots/) - [PyPI (`strands-robots`)](https://pypi.org/project/strands-robots/) - [GitHub](https://github.com/strands-labs/robots)
...
> **Note:** Robots Sim is now **archived**. Its simulation and iterative-control workflow have been folded into [Strands Robots](https://strandsagents.com/latest/documentation/docs/labs/robots/), where `Robot()` returns a MuJoCo simulation by default - no separate `strands-robots-sim` install is needed. The example above is retained as a historical record of the launch API.
...
**Get started with AI Functions:** [Documentation](https://strandsagents.com/latest/documentation/docs/labs/ai-functions/) - [PyPI (`strands-ai-functions`)](https://pypi.org/project/strands-ai-functions/) - [GitHub](https://github.com/strands-labs/ai-functions)
