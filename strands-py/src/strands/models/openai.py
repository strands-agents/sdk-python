...
from .model import AgentContext, BaseModelConfig, CacheConfig, Model
...
class OpenAIModel(Model):
    ...
    async def stream(
        ...
        **kwargs: Any,
        ...
        request = self.format_request(messages, tool_specs, system_prompt, tool_choice, agent_context=agent_context)
