...
Field names use snake_case in Python results and camelCase in TypeScript
results (execution_time_ms and executionTimeMs respectively), matching each
SDK's surface conventions.
