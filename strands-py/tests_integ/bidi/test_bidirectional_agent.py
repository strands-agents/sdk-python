...
PROVIDER_CONFIGS = {
    "nova_sonic": {
        "model_factory": create_nova_sonic_model,
    ...
    "openai": {
        "model_factory": BidiOpenAIRealtimeModel,
        "model_kwargs": {
    ...
    "gemini_live": {
        "model_factory": BidiGeminiLiveModel,
        "model_kwargs": {
