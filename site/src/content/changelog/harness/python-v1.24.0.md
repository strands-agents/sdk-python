...
entries:
  ...
  - { type: other, breaking: false, scope: null, areas: [multiagent], title: "add workflow for lambda layer publish", pr: 870, prUrl: "https://github.com/strands-agents/sdk-python/pull/870", commit: "66d3db2", commitUrl: "https://github.com/strands-agents/sdk-python/commit/66d3db2", author: dbschmigelski }
