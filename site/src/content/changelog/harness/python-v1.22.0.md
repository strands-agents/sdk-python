...
entries:
  ...
  - { type: other, breaking: false, scope: null, areas: [], title: "update pytest requirement from <9.0.0,>=8.0.0 to >=8.0.0,<10.0.0 in the dev-dependencies group by @dependabot[bot]", pr: 1161, prUrl: "https://github.com/strands-agents/sdk-python/pull/1161", commit: "10a8e4a", commitUrl: "https://github.com/strands-agents/sdk-python/commit/10a8e4a", author: "dependabot[bot]" }
  ...
  - { type: other, breaking: false, scope: null, areas: [], title: "update sphinx requirement from <9.0.0,>=5.0.0 to >=5.0.0,<10.0.0 by @dependabot[bot]", pr: 1426, prUrl: "https://github.com/strands-agents/sdk-python/pull/1426", commit: "68257a3", commitUrl: "https://github.com/strands-agents/sdk-python/commit/68257a3", author: "dependabot[bot]" }
