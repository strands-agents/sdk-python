...
entries:
  ...
  - { type: other, breaking: false, scope: null, areas: [model], title: "update openai requirement from <1.100.0 to <1.102.0 by @dependabot[bot]", pr: 722, prUrl: "https://github.com/strands-agents/sdk-python/pull/722", commit: "ec000b8", commitUrl: "https://github.com/strands-agents/sdk-python/commit/ec000b8", author: "dependabot[bot]" }
