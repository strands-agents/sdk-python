...
entries:
  ...
  - { type: other, breaking: false, scope: null, areas: [model], title: "update litellm requirement from <=1.82.6,>=1.75.9 to >=1.75.9,<=1.83.13 by @dependabot[bot]", pr: 2197, prUrl: "https://github.com/strands-agents/sdk-python/pull/2197", commit: "609723a", commitUrl: "https://github.com/strands-agents/sdk-python/commit/609723a", author: "dependabot[bot]" }
  - { type: other, breaking: false, scope: null, areas: [], title: "update pre-commit requirement from <4.6.0,>=3.2.0 to >=3.2.0,<4.7.0 by @dependabot[bot]", pr: 2185, prUrl: "https://github.com/strands-agents/sdk-python/pull/2185", commit: "5b6aa56", commitUrl: "https://github.com/strands-agents/sdk-python/commit/5b6aa56", author: "dependabot[bot]" }
