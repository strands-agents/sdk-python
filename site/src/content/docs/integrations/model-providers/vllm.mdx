...
result = agent("Pause for 2 seconds, then tell me you are done.")
print(result)
```
...
async def main():
    ...
    await agent.invoke_async("Pause for 2 seconds, then tell me you are done.")
...
- Unknown tool: `Error: unknown tool: fake_tool | allowed_tools=[sleep, search, ...]`
- Missing argument: `Error: tool_name=<sleep> | missing required argument(s): duration`
- Unknown argument: `Error: tool_name=<sleep> | unknown argument(s): invalid_param`
