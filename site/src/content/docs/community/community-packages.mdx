...
Interventions provide composable control handlers for authorization, guardrails, and steering. Use these to add typed decision-making (proceed, deny, guide, confirm, transform) to your agents without modifying core logic.

<SimpleTable data={communityInterventions} columns={packageColumns}>
  {renderCell}
</SimpleTable>
