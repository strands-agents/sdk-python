...
1. `calculator`: A small custom tool, defined in `math_assistant.py`, that applies an arithmetic operator to two numbers.
...
flowchart TD
    ...
    MathAssistant --> CalcTool["Calculator Tool<br/><br/>Two-operand arithmetic<br/>operations"]
