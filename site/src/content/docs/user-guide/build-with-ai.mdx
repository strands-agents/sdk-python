...
- **Start from examples** by pointing your AI tool at the [samples repository](https://github.com/strands-agents/samples) for common patterns like multi-agent systems, structured output, and tool use.
