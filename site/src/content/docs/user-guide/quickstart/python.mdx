...
1. How many stars does the strands-agents/harness-sdk repo have? Check
   https://api.github.com/repos/strands-agents/harness-sdk
...
```python
result = agent(
    "How many stars does the strands-agents/harness-sdk repo have? Check "
    "https://api.github.com/repos/strands-agents/harness-sdk"
)
            ...
            "content": [
              {
                "toolResult": {
                  "content": [
                    {
                      "text": "{\"status\": 200, \"stargazers_count\": 3247, ...}"
                    }
                  ],
                  "status": "success",
                  "toolUseId": "tooluse_jR3LAfuASrGil31Ix9V7qQ"
...
async def process_streaming_response():
    prompt = (
        ...
        "Check https://api.github.com/repos/strands-agents/harness-sdk"
    )
