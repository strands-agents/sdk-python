...
# Create an agent with both of our custom tools
...
# calculator is the tool defined in agent.py above
...
- [Custom tools](../concepts/tools/custom-tools.md) - More on the `@tool` decorator used by the `calculator` and `letter_counter` tools above
