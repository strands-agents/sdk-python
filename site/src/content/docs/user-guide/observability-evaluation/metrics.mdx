...
result = agent(
    "Fetch the current weather from https://api.open-meteo.com/v1/forecast"
    "?latitude=47.6&longitude=-122.3&current=temperature_2m"
    " and tell me if I need a jacket in Seattle."
)
...
agent = Agent(tools=[http_request])
result = agent(
    "Fetch https://api.github.com/repos/strands-agents/harness-sdk"
    " and tell me how many open issues the repo has."
)
