...
# calculator is defined at the end of this page
...
## The `calculator` tool used above

The examples on this page use a small arithmetic tool so the model has
something to call. It is incidental to the topic — see
[Custom tools](/docs/user-guide/concepts/tools/custom-tools/#basic-example)
for how `@tool` works.
