...
| `gen_ai.usage.cache_read_input_tokens` | Deprecated alias for `gen_ai.usage.cache_read.input_tokens` |
| `gen_ai.usage.cache_write_input_tokens` | Deprecated alias for `gen_ai.usage.cache_creation.input_tokens` |
