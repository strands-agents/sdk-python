...
```typescript
--8<-- "user-guide/concepts/model-providers/vercel_imports.ts:structured_output_imports"

--8<-- "user-guide/concepts/model-providers/vercel.ts:structured_output"
```
...
- Usage and token tracking including cache read/write and reasoning tokens
