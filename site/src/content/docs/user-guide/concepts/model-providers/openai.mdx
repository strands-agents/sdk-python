...
Guides for specific OpenAI-compatible services, such as
[OpenRouter](../../../integrations/model-providers/openrouter.mdx) and
[Fireworks AI](../../../integrations/model-providers/fireworksai.mdx), are in the
