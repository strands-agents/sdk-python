...
- `estimate_utilization()`: Compute the ratio of input tokens to context window limit
...
- `estimateUtilization()`: Compute the ratio of input tokens to context window limit
