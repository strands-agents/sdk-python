...
These are counted separately from `inputTokens` rather than included in it. See [Token
Accounting](../../observability-evaluation/metrics#token-accounting) for how to combine
them into a cost.
