...
| `repetitiveHandoffDetectionWindow` | Number of recent agents to check for ping-pong behavior | 0 (disabled) |
| `repetitiveHandoffMinUniqueAgents` | Minimum unique agents required in the recent sequence | 0 (disabled) |
