...
The [Teacher's Assistant](https://github.com/strands-agents/samples) example in the samples repository demonstrates an orchestrator agent that routes student queries to specialized agents for math, English, language translation, computer science, and general knowledge.
