...
agent("What's the current temperature in London?")
```
...
agent("Summarize the strands-agents/harness-sdk repository on GitHub.")
```
...
agent("What is the capital of France, and what is the temperature there right now?")
```
