...
description: "Build voice-enabled AI agents with real-time audio streaming. Works with Bedrock Nova Sonic, Google Gemini Live, and OpenAI Realtime."
experimental: true
---
...
This includes all 3 supported providers (Bedrock Nova Sonic, Google Gemini Live, and OpenAI Realtime),
`BidiTextIO`, and audio processing. Local microphone and speaker access also requires
the `bidi-pyaudio` extra and the PortAudio system library.
...
<Tabs>
<Tab label="Bedrock Nova Sonic">

```bash
# With local microphone and speaker I/O
pip install "strands-agents[bidi-bedrock,bidi-pyaudio]"
...
pip install "strands-agents[bidi-bedrock,bidi-pyaudio,bidi-openai]"

# Server-side only
pip install "strands-agents[bidi-bedrock,bidi-openai]"
```
</Tab>
...
```bash
# With local audio I/O
pip install "strands-agents[bidi-bedrock,bidi-pyaudio,bidi-google]"

# Server-side only
pip install "strands-agents[bidi-bedrock,bidi-google]"
```
</Tab>
</Tabs>
...
- **[Bedrock Nova Sonic](models/bedrock.md)** - Amazon's bidirectional streaming model via AWS Bedrock
- **[OpenAI Realtime](models/openai.md)** - OpenAI's Realtime API for voice conversations
- **[Google Gemini Live](models/google.md)** - Google's Gemini Live multimodal streaming API
...
- **Model Providers:**
    - [Bedrock Nova Sonic](models/bedrock.md) - Amazon Bedrock's bidirectional streaming model
    - [OpenAI Realtime](models/openai.md) - OpenAI's Realtime API
    - [Google Gemini Live](models/google.md) - Google's Gemini Live API
