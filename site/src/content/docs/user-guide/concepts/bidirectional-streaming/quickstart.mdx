...
description: "Build voice-enabled AI agents with real-time audio streaming. Works with Bedrock Nova Sonic, Google Live, and OpenAI Realtime."
experimental: true
---
...
This includes all 3 supported providers (Bedrock Nova Sonic, Google Live, and OpenAI Realtime) plus `BidiAudioIO` and `BidiTextIO` for local development.
...
- **[Google Live](models/google.md)** - Google's Gemini Live multimodal streaming API
...
- **Model Providers:**
    ...
    - [Google Live](models/google.md) - Google's Gemini Live API
