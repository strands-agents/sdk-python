...
4. If the validator passes, the run terminates with a "satisfied" stop reason.
...
6. If the attempt limit or timeout is exhausted, the run terminates without retrying.
