...
See [Available Sandboxes](./available-sandboxes.mdx) for Docker, SSH, and Modal
configuration, programmatic access, and streaming output.
...
- [Available Sandboxes](./available-sandboxes.mdx) - Docker, SSH, and Modal
  backends, programmatic access, and streaming
