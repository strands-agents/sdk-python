...
class WeatherReport(BaseModel):
    ...
    needs_jacket: bool = Field(description="whether a jacket is recommended")
...
res = tool_agent(
    "Do I need a jacket in Seattle today?",
...
```typescript
--8<-- "user-guide/concepts/agents/structured-output_imports.ts:combining_tools_imports"
