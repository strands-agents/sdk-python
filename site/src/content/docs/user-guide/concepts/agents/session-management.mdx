...
Snapshot-based session managers accept any [Storage](../storage/index.mdx) backend, including
`InMemoryStorage`, `LocalFileStorage`, `S3Storage`, and custom implementations. See
[Storage](../storage/index.mdx) for backend configuration, tradeoffs, custom backends, and
...
[Storage](../storage/index.mdx) backend directly — the
