...
tool-call content they carry. If your session store can be written by something
outside your application, treat that history as untrusted and clear tool-call
content from it. See [Trusted Message History](../../safety-security/trusted-message-history.md).
:::
