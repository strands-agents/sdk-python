...
A framework-agnostic evaluation supports solves the issues above through greater interoperability:
...
The following example swaps Cldue Agents for OpenAI Agents to evaluate the same commit message task,
