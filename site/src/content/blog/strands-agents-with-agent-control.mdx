...
![Agent Control architecture: controls evaluate at each step of the agent workflow, with the Agent Control Server managing policies centrally](./agent-control-architecture.webp)
