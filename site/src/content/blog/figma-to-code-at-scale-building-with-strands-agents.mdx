...
The system connects to external services through MCPs: a Figma MCP for design data, a REC MCP for the ad layout system, and a Weblab MCP for experimentation. All agents share access to a data store layer (Amazon Bedrock Knowledge Base for UX guidelines and component rules, S3 for generated variations, and DynamoDB for layout metadata).
