...
The model-driven approach requires robust [evaluation](/docs/user-guide/evals-sdk/quickstart/) to build confidence that agents perform as expected. Since model-driven agents make dynamic decisions rather than following predetermined paths, evaluation becomes both more important and more nuanced.
...
Ready to try it? Check out the [Strands Agents documentation](/) and [examples](https://github.com/strands-agents/samples) to start building your own model-driven agents.
