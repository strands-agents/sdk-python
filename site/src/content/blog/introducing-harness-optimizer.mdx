...
- You have a reward signal to separate good from bad, whether a programmatic check or an LLM judge, e.g., [AgentCore Eval](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/evaluation.html) and [Strands Evals](https://github.com/strands-agents/evals).
