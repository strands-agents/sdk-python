          ...
          `arn:aws:iam::${cdk.Stack.of(this).account}:oidc-provider/token.actions.githubusercontent.com`,
          {
            ...
            StringLike: {
              'token.actions.githubusercontent.com:sub': [
                ...
                'repo:strands-agents/private-sdk-python-staging:*',
                'repo:strands-agents/tools:*',
                'repo:strands-agents/private-tools-staging:*',
                'repo:strands-agents/agent-builder:*',
                'repo:strands-agents/evals:*',
                'repo:strands-agents/private-docs-staging:*',
              ],
            },
          },
  ...
  private addLegacyBasePolicy(): void {
      ...
      new iam.PolicyStatement({
        ...
        resources: [
          stack.formatArn({
            ...
            region: 'us-east-1',
            resource: 'secret',
            resourceName: 'model-provider-api-key-ayh5Is',
    ...
    this.role.addToPolicy(
      new iam.PolicyStatement({
        ...
        resources: ['arn:aws:s3:::nova-reels-e2e-test-*', 'arn:aws:s3:::strands-integ-tests-resources-*'],
      }),
    );
